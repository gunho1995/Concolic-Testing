...
void testGcov(int argc, char* argv[]);
...
void testGcov(int argc, char* argv[]){
	...
	//TODO: make 10 Test case to achive 100% coverage 
    int argcFake = 1;
	char* argvFake1[1];
	char* argvFake3[3];
	char* argvFake4[4];
    ...
    argvFake4[1] = "-n";
    argvFake4[2] = "all";
    argvFake4[3] = "yesterday.txt";

	mainGrep(argcFake, argvFake4);
/*
	argcFake = 3;

    argvFake3[0] = argv[0];
    argvFake3[1] = "all";
    argvFake3[2] = "yesterday.txt";

    mainGrep(argcFake, argvFake3);
